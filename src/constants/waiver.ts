...
By registering your child(ren) for the HES Childcare Service on May 30, 2026, you confirm that you have read, understood, and agreed to the terms set forth in this waiver. You acknowledge that participation is voluntary and that you have had adequate opportunity to review these terms prior to signing.

You represent and warrant that: (a) you are the legal parent or guardian of the child(ren) named in this registration; (b) all information provided in the registration form is accurate and complete; (c) your child(ren) are in good health and fit to participate in supervised childcare activities; and (d) you have disclosed all relevant medical conditions, allergies, dietary restrictions, and behavioral considerations.
...
3. MEDICAL AUTHORIZATION & HEALTH DISCLOSURE
...
You agree to disclose all known allergies (food, environmental, medication), current medications, chronic medical conditions, behavioral diagnoses, and any special needs that may affect your child's participation. You understand that failure to disclose relevant health information may increase risk to your child and that HES cannot be held liable for complications arising from undisclosed conditions.

4. CODE OF CONDUCT & SUPERVISION POLICIES
...
By checking the photo consent box during registration, you grant HES permission to photograph or video-record your child(ren) during the May 30, 2026 event. Such media may be used for internal records, promotional materials on HES social media channels and website, and event recap communications. You may opt out of photo/video consent during registration, in which case HES will make reasonable efforts to exclude your child from promotional media. HES will not share identifiable images of minors with third parties without additional written consent.

6. GOVERNING LAW

This Agreement shall be governed by and construed in accordance with the laws of the State of Illinois. Any dispute arising under this Agreement shall be resolved exclusively in the courts of Cook County, Illinois. If any provision of this Agreement is found to be unenforceable, the remaining provisions shall continue in full force and effect.
...
export const WAIVER_SECTIONS = [
  {
    id: 'agreement',
    title: '1. Agreement to Participate',
    content: `By registering your child(ren) for the HES Childcare Service on May 30, 2026, you confirm that you have read, understood, and agreed to the terms set forth in this waiver. You acknowledge that participation is voluntary and that you have had adequate opportunity to review these terms prior to signing.
...
â€¢ Parents are responsible for ensuring their child has appropriate clothing, personal items, and any required medications clearly labeled`,
  ...
  {
    id: 'media',
    title: '5. Media & Photography Release',
    content: `By checking the photo consent box during registration, you grant HES permission to photograph or video-record your child(ren) during the May 30, 2026 event. Such media may be used for internal records, promotional materials on HES social media channels and website, and event recap communications. You may opt out of photo/video consent during registration, in which case HES will make reasonable efforts to exclude your child from promotional media. HES will not share identifiable images of minors with third parties without additional written consent.`,
  },
  {
    id: 'governing',
